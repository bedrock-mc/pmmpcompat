...
class BlockStateNames
{
    ...
    public const MC_BLOCK_FACE = "mc_block_face";
    public const MC_CARDINAL_DIRECTION = "mc_cardinal_direction";
    public const MC_FACING_DIRECTION = "mc_facing_direction";
    public const MC_VERTICAL_HALF = "mc_vertical_half";
