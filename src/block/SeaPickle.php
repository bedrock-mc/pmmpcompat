...
class SeaPickle extends \pocketmine\block\Block
{
    public function __construct(mixed ...$args) { parent::__construct('minecraft:seapickle', 'SeaPickle'); }
    ...
    public function isUnderwater(mixed ...$args): mixed { return $this->compatMethod(__FUNCTION__, $args); }
    ...
    public function setUnderwater(mixed ...$args): mixed { return $this->compatMethod(__FUNCTION__, $args); }
}
