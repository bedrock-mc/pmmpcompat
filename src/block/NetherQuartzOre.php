...
class NetherQuartzOre extends \pocketmine\block\Block
{
    public function __construct(mixed ...$args) { parent::__construct('minecraft:netherquartzore', 'NetherQuartzOre'); }
