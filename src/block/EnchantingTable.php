...
class EnchantingTable extends \pocketmine\block\Block
{
    public function __construct(mixed ...$args) { parent::__construct('minecraft:enchantingtable', 'EnchantingTable'); }
