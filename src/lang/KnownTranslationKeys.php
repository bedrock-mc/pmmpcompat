...
{
    public const ACCEPT_LICENSE = 'accept.license';
    ...
    public const DEFAULT_GAMEMODE = 'default.gamemode';
    public const DEFAULT_VALUES_INFO = 'default.values.info';
    ...
    public const ENCHANTMENT_HEAVY_WEAPON_BREACH = 'enchantment.heavy.weapon.breach';
    public const ENCHANTMENT_HEAVY_WEAPON_DENSITY = 'enchantment.heavy.weapon.density';
    public const ENCHANTMENT_HEAVY_WEAPON_WINDBURST = 'enchantment.heavy.weapon.windburst';
    ...
    public const ENCHANTMENT_SOUL_SPEED = 'enchantment.soul.speed';
    public const ENCHANTMENT_SWIFT_SNEAK = 'enchantment.swift.sneak';
    ...
    public const GAMEMODE_INFO = 'gamemode.info';
    public const GAMEMODE_OPTIONS = 'gamemode.options';
    public const GAMEMODE_SPECTATOR = 'gameMode.spectator';
    public const GAMEMODE_SURVIVAL = 'gameMode.survival';
    public const INVALID_PORT = 'invalid.port';
    public const IP_CONFIRM = 'ip.confirm';
    public const IP_GET = 'ip.get';
    public const IP_WARNING = 'ip.warning';
    ...
    public const ITEMGROUP_NAME_BANNER_PATTERN = 'itemGroup.name.banner.pattern';
    ...
    public const ITEMGROUP_NAME_CORAL_DECORATIONS = 'itemGroup.name.coral.decorations';
    ...
    public const ITEM_RECORD_11_DESC = 'item.record.11.desc';
    public const ITEM_RECORD_13_DESC = 'item.record.13.desc';
    public const ITEM_RECORD_5_DESC = 'item.record.5.desc';
    public const ITEM_RECORD_BLOCKS_DESC = 'item.record.blocks.desc';
    public const ITEM_RECORD_CAT_DESC = 'item.record.cat.desc';
    public const ITEM_RECORD_CHIRP_DESC = 'item.record.chirp.desc';
    public const ITEM_RECORD_CREATOR_DESC = 'item.record.creator.desc';
    public const ITEM_RECORD_CREATOR_MUSIC_BOX_DESC = 'item.record.creator.music.box.desc';
    public const ITEM_RECORD_FAR_DESC = 'item.record.far.desc';
    public const ITEM_RECORD_MALL_DESC = 'item.record.mall.desc';
    public const ITEM_RECORD_MELLOHI_DESC = 'item.record.mellohi.desc';
    public const ITEM_RECORD_OTHERSIDE_DESC = 'item.record.otherside.desc';
    public const ITEM_RECORD_PIGSTEP_DESC = 'item.record.pigstep.desc';
    public const ITEM_RECORD_PRECIPICE_DESC = 'item.record.precipice.desc';
    public const ITEM_RECORD_RELIC_DESC = 'item.record.relic.desc';
    public const ITEM_RECORD_STAL_DESC = 'item.record.stal.desc';
    public const ITEM_RECORD_STRAD_DESC = 'item.record.strad.desc';
    public const ITEM_RECORD_WAIT_DESC = 'item.record.wait.desc';
    public const ITEM_RECORD_WARD_DESC = 'item.record.ward.desc';
    public const LANGUAGE_HAS_BEEN_SELECTED = 'language.has.been.selected';
    ...
    public const NAME_YOUR_SERVER = 'name.your.server';
    public const OP_INFO = 'op.info';
    public const OP_WARNING = 'op.warning';
    public const OP_WHO = 'op.who';
    ...
    public const POCKETMINE_PLUGINS = 'pocketmine.plugins';
    ...
    public const POCKETMINE_WILL_START = 'pocketmine.will.start';
    public const PORT_WARNING = 'port.warning';
    ...
    public const QUERY_DISABLE = 'query.disable';
    public const QUERY_WARNING1 = 'query.warning1';
    public const QUERY_WARNING2 = 'query.warning2';
    public const RECORD_NOWPLAYING = 'record.nowPlaying';
    public const SERVER_PORT = 'server.port';
    public const SERVER_PORT_V4 = 'server.port.v4';
    public const SERVER_PORT_V6 = 'server.port.v6';
    public const SERVER_PROPERTIES = 'server.properties';
    public const SETTING_UP_SERVER_NOW = 'setting.up.server.now';
    public const SKIP_INSTALLER = 'skip.installer';
    ...
    public const TILE_RESPAWN_ANCHOR_NOTVALID = 'tile.respawn.anchor.notValid';
    public const TILE_RESPAWN_ANCHOR_RESPAWNSET = 'tile.respawn.anchor.respawnSet';
    public const VIEW_DISTANCE = 'view.distance';
    public const WELCOME_TO_POCKETMINE = 'welcome.to.pocketmine';
    public const WHITELIST_ENABLE = 'whitelist.enable';
    public const WHITELIST_INFO = 'whitelist.info';
    public const WHITELIST_WARNING = 'whitelist.warning';
    public const YOU_HAVE_FINISHED = 'you.have.finished';
    public const YOU_HAVE_TO_ACCEPT_THE_LICENSE = 'you.have.to.accept.the.license';
}
